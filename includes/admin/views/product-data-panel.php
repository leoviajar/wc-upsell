            ...
            <tbody id="wc-upsell-kits-list">
                <?php if ( ! empty( $kits ) ) : ?>
                    ...
                    <tr class="wc-upsell-kit-row">
                        ...
                        <td>
                            <input type="number" 
                                   name="wc_upsell_kits[<?php echo $index; ?>][compare_price]" 
                                   value="<?php echo esc_attr( isset( $kit['compare_price'] ) ? $kit['compare_price'] : '' ); ?>"
                                   min="0"
                                   step="0.01"
                                   placeholder="<?php esc_attr_e( 'Opcional', 'wc-upsell' ); ?>"
                                   class="regular-text kit-compare-price" />
                        </td>
                        <td>
...
<tr class="wc-upsell-kit-row">
    ...
    <td>
        <input type="number" 
               name="wc_upsell_kits[{{INDEX}}][compare_price]" 
               value=""
               min="0"
               step="0.01"
               placeholder="<?php esc_attr_e( 'Opcional', 'wc-upsell' ); ?>"
